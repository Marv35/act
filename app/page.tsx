  ...
  return (
    <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="space-y-6">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-green-600 leading-tight">
              Rejoignez-nous à <span className="text-yellow-500">l'ACT</span> !
            </h2> 
          ...
          <div className="flex justify-center">
            <div className="relative w-full">
              <div className="absolute -inset-4 bg-gray-200 rounded-full opacity-20 blur-xl animate-pulse"></div>
              {/* Carousel des images */}
          ...
          <div className="p-6 flex flex-col md:flex-row gap-8">
            <div className="md:w-1/2 space-y-4">
              ...
              <div className="bg-white bg-opacity-70 backdrop-blur-sm rounded-lg p-5 shadow-inner">
                ...
                <p className="mb-4 text-gray-700">
                  ...
                  <br />
                  <strong>Tournoi interne 2027</strong>
                  <br />
                  Notre tournoi interne débutera courant octobre.
                  <br />
                  <strong>Vie du club</strong>
                  <br />
            ...
            <div className="md:w-1/2 relative min-h-[250px] md:min-h-full">
              <div className="relative h-full w-full overflow-hidden rounded-lg">
                <Image
                  src="/images/Terrains/repas_de_tournoi.webp"
                  fill
                  sizes="(max-width: 768px) 100vw, 50vw"
                  alt="Repas de tournoi de tennis en extérieur"
      ...
      <section className="mb-14">
        <div className="relative bg-gradient-to-br from-green-50 to-white rounded-2xl p-10 shadow-xl overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-6">
            <Link
              ...
              className="group inline-flex items-center justify-center rounded-full bg-white border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white font-bold px-8 py-3 text-lg shadow-lg transition-all duration-300 focus:ring-2 focus:ring-blue-300 tracking-wider"
            >
              Facebook
            </Link>
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center justify-center rounded-full bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-white font-bold px-8 py-3 text-lg shadow-lg hover:scale-105 transition-all duration-300 focus:ring-2 focus:ring-pink-300 tracking-wider"
            >
              Instagram
            </Link>
          </div>
        ...
        <div className="flex justify-center">
          ...
          >
            <span className="relative rounded-md bg-white px-8 py-3.5 transition-all duration-300 ease-in-out group-hover:bg-opacity-0">
              <span className="relative text-lg font-semibold text-gray-900 group-hover:text-white">Accéder à Ten'Up</span>
            </span>
          </Link>
        </div>
      </section>
